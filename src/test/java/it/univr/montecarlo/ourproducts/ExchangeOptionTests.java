...
public class ExchangeOptionTests {
	 ...
	 * construct the simulation of two possibly correlated geometric Brownian motions
	 */
	...
	/*
	 * This method computes the analytical value of an exchange option with maturity given by the field
	 * of the class, for a two-dimensional Brownian motion with parameters also given above, using the
	 * analytic formula you can find in the exercise sheet.
	 */
	...
	public void testCorrelation() throws CalculationException {
		...
		for (int i = 0; i <= 20; i++) {
			 ...
			 * two geometric Brownian motions, with possibly dependent stochastic drivers
	...
	/**
	 * It checks if the Monte-Carlo price is close enough to the analytic price for the seed given as a field of this class
	 */
	@Test
	void testExchangeForGivenSeed() {
		try {
			...
			final BrownianMotion brownian = new BrownianMotionFromMersenneRandomNumbers(times, 2, numberOfSimulations, seed);
			/*
			 * this is a finmath class, we use it to get the simulation of a two dimensional
