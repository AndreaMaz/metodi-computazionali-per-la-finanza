...
import it.univr.trees.assetderivativevaluation.enhancedproducts.EuropeanNonPathDependentOption;
...
public class ApproximatingModelsTest {
	...
	public static void main(String[] args) {
		...
		int maxNumberOfTimes = 501;
		int minNumberOfTimes = 11;
		
		//look at the Plot2D constructor.
		final Plot2D plotBoyle = new Plot2D(minNumberOfTimes, maxNumberOfTimes, (maxNumberOfTimes-minNumberOfTimes+2)/2,
				Arrays.asList(
