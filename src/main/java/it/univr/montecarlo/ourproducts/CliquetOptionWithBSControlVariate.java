...
public class CliquetOptionWithBSControlVariate extends AbstractAssetMonteCarloProduct {
	 ...
	 * cap globalCap and partition of the interval given by the TimeDiscretization object representing
	 *   
	 * 0=t_0 <= t_1 <=..<= t_N =T
	 *   
	 * is
	...
	//private method used to compure the analytic value of the control variate, see the notes
