...
public abstract class ApproximatingTrinomialModel {
	...
	/*
	 * This is of fundamantal importance in our implementation: we give it the value of the possible up 
	 * movement and of the probaility to move up according to the specific model we consider (that is,
	...
	//this is an abstract method which gets implemented in the derived classes : it sets up factors and up probability
