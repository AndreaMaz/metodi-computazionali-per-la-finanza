...
public class BoyleModel extends ApproximatingTrinomialModel {
	/**
	 * It constructs an object which represents the approximation of a Black-Scholes model via the Boyle model.
	 * 
	...
	/**
	 * It computes and returns the up movement and up probability of the Trinomial model for the Boyle model
	 * @return an arrays of two elements: the first is the up probability, the second one the up movement.
	 */
	@Override
	protected double[] getUpFactorAndUpProbabilityOfTrinomialModel() {
